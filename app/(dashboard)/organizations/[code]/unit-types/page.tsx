...
import { CreateOrganizationalUnitTypeDialog } from "@/components/organizations/unit-types/create-organizational-unit-type-dialog";
import { OrganizationalUnitTypeTree } from "@/components/organizations/unit-types/organizational-unit-type-tree";
...
type OrganizationUnitTypesPageProps = {
  params: Promise<{
    code: string;
  }>;
};

export default async function OrganizationUnitsTypesPage({
  params,
}: OrganizationUnitTypesPageProps) {
